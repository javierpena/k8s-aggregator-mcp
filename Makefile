...
KUSTOMIZE_IMAGE := quay.io/REPLACE_WITH_YOUR_USERNAME/k8s-aggregator-mcp
...
help:
	...
	@echo ""
	@echo "Variables:"
	@echo "  IMAGE		        Image to build (default:  quay.io/$(QUAY_WORKSPACE)/k8s-aggregator-mcp:$(VERSION))"
